...
const Contact = () => {
  ...
  return (
    <section className='font-pathwayExtreme w-full h-auto sm:h-[700px] flex py-20 border-x border-black/10'>
    ...
    <div className='sm:w-[50%] py-8 px-8 border border-black/10'>
      ...
      <div className='flex flex-col xl:flex-row gap-3 w-full'>
       <input type="text" placeholder='enter your first name' className='bg-transparent border border-black/10  w-full xl:w-[49%] h-[50px] sm:h-[45px] lg:h-[50px] xl:h-[60px] px-4 outline-none text-[15px] xl:text-[16px]'/>
       <input type='text' placeholder='enter your second name' className='bg-transparent border border-black/10  w-full xl:w-[49%] h-[50px] sm:h-[45px] lg:h-[50px] xl:h-[60px] px-4 outline-none text-[15px] xl:text-[16px]'/>
     </div> 
     {/* second */}

     <div className='flex gap-3 w-full'>
       <textarea type="textarea" placeholder='enter your details here (maximum 100  words)' className='bg-transparent border border-black/10  w-full h-[100px] xl:h-[120px] px-4 outline-none text-[15px] xl:text-[16px] resize-none pt-3'/>
     </div>

     <div className='flex flex-col sm:flex-row gap-3 w-full'>
       <input type="email" placeholder='enter your email here' className='bg-transparent border border-black/10  w-full sm:w-[70%] h-[50px] sm:h-[45px] lg:h-[50px] xl:h-[60px] px-4 outline-none text-[15px] xl:text-[16px]'/>
