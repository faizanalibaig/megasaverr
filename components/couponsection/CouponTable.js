...
const CouponTable = ({ couponHeading, couponList }) => {
  return (
    <section className='bg-black text-white flex flex-col px-5 sm:px-16 lg:px-32 xl:px-40'>
      <section className='bg-black text-white w-full h-[60px] border-l border-t border-b border-black/10 flex bg-gray-100'>
      ...
      <section className='bg-black text-white flex flex-col w-full h-auto border-l border-black/10'>
