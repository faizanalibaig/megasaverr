      ...
      <section className='flex'>
        ...
        <section className='w-full'>
          <div className='w-full h-full flex flex-col border-2 border-gray-50/5'>
            ...
            {/* Description section */}
            <section className='bg-black text-white w-full h-full border-b-2 border-gray-50/5'>
              <p id='description' className='text-[14px] sm:text-[15px] xl:text-[18px] px-3 sm:px-20 lg:px-5 w-full h-auto text-center py-8'>
            ...
            <div id='mainButton' className='bg-black text-white text-[14px] sm:text-[15px] xl:text-[18px] w-full h-auto py-8 flex justify-center gap-2'>
              ...
              <Link href='/discounts'>
                <button className='px-3 lg:px-4 py-2 border-2 border-gray-50/5 flex gap-1 items-center'>
                  <span>discounts</span>
                  <MdArrowOutward />
                </button>
              </Link>
