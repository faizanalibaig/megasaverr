...
const Footer = () => {
  ...
  return (
    <section className='border-[2px] border-gray-50/25 w-full h-[550px] sm:h-[450px] lg:h-[400px] font-pathwayExtreme sm:pt-5'>
      ...
      <div className='h-[10%] border-y-[2px] border-gray-50/25 flex items-center px-5 justify-between text-[10px] sm:text-[11px] lg:text-[11px] xl:text-[12px]'>
      <p>megasaverr, Inc.</p>
