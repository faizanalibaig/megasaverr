...
const WelcomeNotification = () => {
  ...
  return (
    !notificationCondition && (
      <section className='bg-black text-white h-auto lg:h-[100px] w-full px-6 sm:px-7 lg:px-6 xl:px-10 py-3 lg:py-5 border-[2px] border-gray-50/25 font-robotoMono flex flex-col gap-5 lg:gap-0 lg:flex-row text-[13px] sm:text-[14px] xl:text-[16px]'>
