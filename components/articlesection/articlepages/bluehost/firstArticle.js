  ...
  return (
    <section className='w-full h-auto flex py-12 sm:py-16 lg:py-20 border-x border-black/10 font-pathwayExtreme'>
      ...
      <section className='w-[90%] h-full'>
        ...
        {/* Disclaimer content */}
        <section className='border-b border-black/10 px-5 sm:px-16 lg:px-32 xl:px-40 py-8 sm:py-12 lg:pt-3 lg:pb-16 flex flex-col gap-10 text-[14px] sm:text-[15px] xl:text-[18px]'>
          <p>
          ...
          <section className='flex gap-2'>
            <button className='bg-gray-50 py-2 px-4 border border-black/10'>
                purchase now
            </button>
            <button className='bg-gray-50 py-2 px-4 border border-black/10'>
          ...
          <section className='w-full h-[55px] flex justify-end'>
            <div className=' w-full border border-black/10 sm:w-auto bg-gray-50 rounded-[12px] flex 
            justify-between sm:justify-start items-center gap-1 xl:gap-2 px-3 sm:px-4'>
              ...
              <section className='flex'>
                {emojis.map(emoji => (
                  <div
                    key={emoji.id}
                    className={`p-1 sm:p-2 rounded-full cursor-pointer ${selectedEmoji === emoji.id ? 'bg-gray-200' : 'hover:bg-gray-200'}`}
